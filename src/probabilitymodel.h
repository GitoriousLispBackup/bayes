...
class ProbabilityModel : public QAbstractTableModel {
    Q_OBJECT

public:
    ProbabilityModel(GraphicsNode *n, QObject *parent = 0);
...
public slots:
    void setSelection(QModelIndex i);

private:
    GraphicsNode *node;
    QList<GraphicsNode*> parents;
